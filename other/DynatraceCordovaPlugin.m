...
{   
    ...
    if ([command.arguments objectAtIndex:0]) {
        id<DTXUserPrivacyOptions> privacyConfig = [Dynatrace userPrivacyOptions];
        privacyConfig.dataCollectionLevel = [[[command.arguments objectAtIndex:0] valueForKey:@"_dataCollectionLevel"] intValue];
        privacyConfig.crashReportingOptedIn = [[command.arguments objectAtIndex:0] valueForKey:@"_crashReportingOptedIn"];
